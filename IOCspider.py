...
def save2file(dic_list):
    pd.DataFrame(dic_list).to_excel('reportlist2.xlsx')
...
for i in range(1, 187):
    ...
    for l in list:
        ...
        try:
            ...
            try:
                download_btn = rl.find_element_by_xpath("//button[@class='ant-btn antd-pro-pages-home-components-apt-list-btn3 ant-btn-primary ant-btn-sm']")
                if download_btn:
